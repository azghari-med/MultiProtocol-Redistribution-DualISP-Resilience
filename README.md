...
`OSPF` · `EIGRP` · `RIP` · `Redistribution` · `Stub Areas` · `Dual ISP` · `PBR` · `IP SLA`

![Cisco](https://img.shields.io/badge/Cisco-1BA0D7?style=for-the-badge&logo=cisco&logoColor=white)
![Level](https://img.shields.io/badge/Level-Advanced_(ENARSI)-red?style=for-the-badge)
![Status](https://img.shields.io/badge/Status-Working-success?style=for-the-badge)

*Two companies. Three routing protocols. Two ISPs. One clean integration.*
